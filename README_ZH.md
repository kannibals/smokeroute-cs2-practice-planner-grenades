...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="SmokeRoute — Counter-Strike 2 — Grenades" width="64" height="64">
<h1>SmokeRoute — Counter-Strike 2 — Grenades</h1>
</div>

独立的项目设计文档，适用对象： **Counter-Strike 2**。
...
- **地图练习库** (Map drill library) — 规划模块，尚未实现。
- **灵敏度比较笔记** (Sensitivity comparison notes) — 规划模块，尚未实现。
- **练习记录** (Practice session log) — 规划模块，尚未实现。
